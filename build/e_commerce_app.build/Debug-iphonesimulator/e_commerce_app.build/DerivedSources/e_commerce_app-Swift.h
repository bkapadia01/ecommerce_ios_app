...
#ifndef E_COMMERCE_APP_SWIFT_H
#define E_COMMERCE_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="e_commerce_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14e_commerce_app11AppDelegate")
...
SWIFT_CLASS("_TtC14e_commerce_app18HomeViewController")
...
SWIFT_CLASS("_TtC14e_commerce_app19LoginViewController")
@interface LoginViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Nullable loginErrorLabel;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified loginUsernameField;
...
SWIFT_CLASS("_TtC14e_commerce_app22RegisterViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified registerErrorLabel;
- (void)viewDidLoad;
- (IBAction)cancelRegistrationTapped:(id _Nonnull)sender;
- (IBAction)signUpButtonTapped:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS_NAMED("RegisteredUser")
...
@interface RegisteredUser (SWIFT_EXTENSION(e_commerce_app))
...
SWIFT_CLASS("_TtC14e_commerce_app13SceneDelegate")
